...
from app.database.dal import payment_dal, user_billing_dal, user_billing_dal as ub
                            ...
                            if user_id_str and user_id_str.isdigit():
                                ...
                                if isinstance(payment_method, dict) and payment_method.get("id"):
                                    ...
                                    try:
                                        ...
                                        from app.keyboards.inline.user_keyboards import get_back_to_payment_methods_keyboard
                                        await bot.send_message(
                                            chat_id=user_id,
