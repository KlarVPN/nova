...
from app.database.dal import user_dal, subscription_dal
from app.database.dal import message_log_dal
from app.database.models import User
from app.states.admin_states import AdminStates
from app.keyboards.inline.admin_keyboards import get_back_to_admin_panel_keyboard
...
from app.utils import get_message_content, send_direct_message
...
from app.utils.telegram_markup import (
...
async def users_list_handler(callback: types.CallbackQuery,
    ...
    try:
        # Get paginated users
        from app.keyboards.inline.admin_keyboards import get_users_list_keyboard
