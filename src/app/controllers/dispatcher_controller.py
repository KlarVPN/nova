...
from src.middlewares.i18n import I18nMiddleware, get_i18n_instance
from src.middlewares.ban_check_middleware import BanCheckMiddleware
from src.middlewares.action_logger_middleware import ActionLoggerMiddleware
from src.middlewares.profile_sync import ProfileSyncMiddleware
