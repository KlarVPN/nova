...
from src.database.dal import payment_dal, user_billing_dal, user_billing_dal as ub
...
from src.services.lknpd_service import LknpdService
from src.middlewares.i18n import JsonI18n
from src.config import Settings
from src.services.notification_service import NotificationService
from src.keyboards.inline.user_keyboards import get_connect_and_main_keyboard
from src.utils.text_sanitizer import sanitize_display_name, username_for_display
from src.utils.config_link import prepare_config_links
                            ...
                            if user_id_str and user_id_str.isdigit():
                                ...
                                if isinstance(payment_method, dict) and payment_method.get("id"):
                                    ...
                                    try:
                                        ...
                                        from src.keyboards.inline.user_keyboards import get_back_to_payment_methods_keyboard
                                        await bot.send_message(
                                            chat_id=user_id,
