...
from src.database.dal import message_log_dal
from src.database.models import User
from src.states.admin_states import AdminStates
from src.keyboards.inline.admin_keyboards import get_back_to_admin_panel_keyboard
...
from src.utils import get_message_content, send_direct_message
...
from src.utils.telegram_markup import (
...
async def users_list_handler(callback: types.CallbackQuery,
    ...
    try:
        # Get paginated users
        from src.keyboards.inline.admin_keyboards import get_users_list_keyboard
...
async def format_user_card(user: User, session: AsyncSession, 
    ...
    try:
        ...
        try:
            from src.database.dal import payment_dal
